...
PLOTBANDPASS_REVISION_STRING = "$Id: plotbandpass3.py,v 1.213 2022/01/18 22:07:21 thunter Exp $" 
import pylab as pb
...
def version(showfile=True):
    ...
    """
    myversion = "$Id: plotbandpass3.py,v 1.213 2022/01/18 22:07:21 thunter Exp $" 
    if (showfile):
